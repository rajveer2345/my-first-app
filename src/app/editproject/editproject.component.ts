...
//  Data={ image:'', projectTitle:'',desc:'', url:''};
//   username: any; 
//   userData: any;
...
//     async onSubmit() {
//       this.updatedData.name = this.formData.image;
//       this.updatedData.username = this.formData.projectTitle;
//       this.updatedData.dob = this.formData.desc;
//       this.updatedData.gender = this.formData.url;
